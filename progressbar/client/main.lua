...
function Process(action, start, tick, finish, canCancel)
	ActionStart()
    Action = action
        ...
        if not isDoingAction then
            ...
            CreateThread(function ()
                ...
                while isDoingAction do
                    ...
                    if Action.canCancel and (IsControlJustPressed(0, 200) or IsControlJustPressed(1, 323)) then
                        TriggerEvent("progressbar:client:cancel")
                        if Config.UseInteractSounds then
            ...
            ShowNotification("You are already doing something!")
           -- TriggerEvent("QBCore:Notify", "You are already doing something!", "error")
        end
    else
        ShowNotification("Cant do that action!")
